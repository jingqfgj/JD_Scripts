...
#热爱奇旅互助版
33 0,6-23/3 * * * node /scripts/jd_19E_help.js >> /scripts/logs/jd_19E_help.log 2>&1
#热爱奇旅互助版
20 0,8 * * * node /scripts/jd_19E_friend.js >> /scripts/logs/jd_19E_friend.log 2>&1
#热爱奇旅互助版
40 0,8 * * * node /scripts/jd_19E_friends.js >> /scripts/logs/jd_19E_friends.log 2>&1
#618个护抽奖机
...
# 京东极速版签到免单
18 3 * * * node /scripts/jd_speed_signfree.js >> /scripts/logs/jd_speed_signfree.log 2>&1
=======
#邀请有礼
